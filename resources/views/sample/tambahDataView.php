    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="">Regist In</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="">Regist Out</a>
          </li>
  ...
  <div class="container-md">
    ...
    <div class="mt-4 mb-3 col-md-8">
      ...
      <div class="col-md-7">
        ...
        <textarea class="form-control" name="deskripsi" id="textareadeskripsi" rows="5"></textarea>
        </br>
      </div>
      ...
      <div class="col-md-7">
        ...
        <select id="inputStatus" name="inputStatus" class="form-select" aria-label="Pilih Status">
          <option selected>Di poli</option>
      ...
      <br>
      <div>
        <button class="btn btn-primary col-md-4" name="submit" value="ya">Tambah Mahasiswa</button>
      </div>
