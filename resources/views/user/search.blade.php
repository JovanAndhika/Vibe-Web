        ...
        <div class="container-fluid flex-grow-1 p-5">
            ...
            <div class="container-fluid text-center justify-content-center align-content-center flex-nowrap mb-4">
                ...
                <form method="get" action="{{ route('user.search') }}" id="searchForm">
                    <input type="text" class="form-control fontMonsseratRegular" placeholder="What to listen to?" aria-label="Username" aria-describedby="addon-wrapping" id="searchInput">
                ...
                <div class="row h-100" id="mainRow">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" style="height: 150px;">
                        <form method="post" action="{{ route('user.jazz') }}">
                            @csrf
                            @method('post')
                            <button type="submit"><img src="{{ asset('img/search/jazzCover.png') }}" alt="" class="img-fluid rounded genre submit" style="object-fit: fit;"></button>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" style="height: 150px;">
                        <form method="post" action="{{ route('user.pop') }}">
                            @csrf
                            @method('post')
                            <button type="submit"><img src="{{ asset('img/search/popCover.png') }}" alt="" class="img-fluid rounded genre" style="object-fit: cover;"></button>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" style="height: 150px;">
                        <form method="post" action="{{ route('user.dangdut') }}">
                            @csrf
                            @method('post')
                            <button type="submit"><img src="{{ asset('img/search/dangdutCover.png') }}" alt="" class="img-fluid rounded genre" style="object-fit: cover;"></button>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" style="height: 150px;">
                        <form method="post" action="{{ route('user.kpop') }}">
                            @csrf
                            @method('post')
                            <button type="submit"><img src="{{ asset('img/search/kpopCover.png') }}" alt="" class="img-fluid rounded genre" style="object-fit: cover;"></button>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" style="height: 150px;">
                        <form method="post" action="{{ route('user.rock') }}">
                            @csrf
                            @method('post')
                            <button type="submit"><img src="{{ asset('img/search/rockCover.png') }}" alt="" class="img-fluid rounded genre" style="object-fit: cover;"></button>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" style="height: 150px;">
                        <form method="post" action="{{ route('user.classical') }}">
                            @csrf
                            @method('post')
                            <button type="submit"><img src="{{ asset('img/search/classicalCover.png') }}" alt="" class="img-fluid rounded genre" style="object-fit: cover;"></button>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" style="height: 150px;">
                        <form method="post" action="{{ route('user.dance') }}">
                            @csrf
                            @method('post')
                            <button type="submit"><img src="{{ asset('img/search/danceCover.png') }}" alt="" class="img-fluid rounded genre" style="object-fit: cover;"></button>
                        </form>
                    </div>
